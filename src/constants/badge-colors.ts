...
export const ENTITY_BADGE_CONFIG = {
  ...
  SERVICE_ORDER: {
    ...
    [SERVICE_ORDER_STATUS.WAITING_ARTWORK]: "purple" as BadgeVariant, // Purple - commercial blocked waiting for artwork (same palette as WAITING_APPROVE)
    [SERVICE_ORDER_STATUS.PAUSED]: "yellow" as BadgeVariant,          // Yellow - paused/on hold
    [SERVICE_ORDER_STATUS.WAITING_APPROVE]: "purple" as BadgeVariant, // Purple - awaiting designer approval
...
/**
 * Accounting Type (DRE bucket) Badge Colors
...
> = {
  ...
  [ACCOUNTING_TYPE.DESPESAS_FIXAS]: {
    ...
    hover: "hover:bg-slate-200 dark:hover:bg-slate-900/30",
  },
  ...
  [ACCOUNTING_TYPE.INVESTIMENTO]: {
    ...
    hover: "hover:bg-indigo-200 dark:hover:bg-indigo-900/30",
  },
  ...
  [ACCOUNTING_TYPE.EPI]: {
    ...
    hover: "hover:bg-cyan-200 dark:hover:bg-cyan-900/30",
  },
  [ACCOUNTING_TYPE.ESCRITORIO]: {
    bg: "bg-violet-100 dark:bg-violet-900/20",
    text: "text-violet-700 dark:text-violet-400",
    hover: "hover:bg-violet-200 dark:hover:bg-violet-900/30",
  },
