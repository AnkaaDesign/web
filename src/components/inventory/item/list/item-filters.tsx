  ...
  return (
    ...
    >
          ...
          <div className="space-y-2">
            ...
            <Combobox
              mode="single"
              value={localState.categoryReviewNeeded ? "yes" : "all"}
              onValueChange={(value) => setLocalState((prev) => ({ ...prev, categoryReviewNeeded: value === "yes" ? true : undefined }))}
              options={[
                { value: "all", label: "Todas" },
                { value: "yes", label: "Apenas a revisar" },
              ]}
              placeholder="Selecione..."
              searchable={false}
            />
