...
import { HoleriteBreakdownCard } from "@/components/personnel-department/payroll/detail/holerite-breakdown-card";
...
export default function PayrollDetailPage() {
  ...
  const breadcrumbs = [
    ...
    { label: "Folha de Pagamento", href: routes.personnelDepartment.payroll.root },
    { label: title },
  ];
