...
export const TASK_STATUS_LABELS: Record<TASK_STATUS, string> = {
  ...
  [TASK_STATUS.COMPLETED]: "Finished",
...
export const SERVICE_ORDER_STATUS_LABELS: Record<SERVICE_ORDER_STATUS, string> = {
  [SERVICE_ORDER_STATUS.PENDING]: "Pending",
  [SERVICE_ORDER_STATUS.IN_PROGRESS]: "Em Andamento",
  [SERVICE_ORDER_STATUS.COMPLETED]: "Finished",
...
export const AIRBRUSHING_STATUS_LABELS: Record<AIRBRUSHING_STATUS, string> = {
  ...
  [AIRBRUSHING_STATUS.COMPLETED]: "Finished",
  [AIRBRUSHING_STATUS.CANCELLED]: "Cancelled",
};

export const CUT_TYPE_LABELS: Record<CUT_TYPE, string> = {
  [CUT_TYPE.VINYL]: "Vinyl",
  [CUT_TYPE.STENCIL]: "Stencil",
};

export const CUT_STATUS_LABELS: Record<CUT_STATUS, string> = {
  [CUT_STATUS.PENDING]: "Pending",
  [CUT_STATUS.CUTTING]: "Cutting",
  [CUT_STATUS.COMPLETED]: "Completed",
};

export const CUT_ORIGIN_LABELS: Record<CUT_ORIGIN, string> = {
  [CUT_ORIGIN.PLAN]: "Plan",
  [CUT_ORIGIN.REQUEST]: "Request",
};

export const CUT_REQUEST_REASON_LABELS: Record<CUT_REQUEST_REASON, string> = {
  [CUT_REQUEST_REASON.WRONG_APPLY]: "Wrong Apply",
  [CUT_REQUEST_REASON.LOST]: "Lost",
...
export const VACATION_STATUS_LABELS: Record<VACATION_STATUS, string> = {
  ...
  [VACATION_STATUS.CANCELLED]: "Cancelled",
  [VACATION_STATUS.IN_PROGRESS]: "Em Andamento",
  [VACATION_STATUS.COMPLETED]: "Completed",
};
...
export const MAINTENANCE_SCHEDULE_STATUS_LABELS: Record<MAINTENANCE_SCHEDULE_STATUS, string> = {
  [MAINTENANCE_SCHEDULE_STATUS.PENDING]: "Pending",
  [MAINTENANCE_SCHEDULE_STATUS.FINISHED]: "Finished",
  [MAINTENANCE_SCHEDULE_STATUS.CANCELLED]: "Cancelled",
};
...
export const EXTERNAL_WITHDRAWAL_STATUS_LABELS: Record<EXTERNAL_WITHDRAWAL_STATUS, string> = {
  [EXTERNAL_WITHDRAWAL_STATUS.PENDING]: "Pending",
  [EXTERNAL_WITHDRAWAL_STATUS.CANCELLED]: "Cancelled",
  [EXTERNAL_WITHDRAWAL_STATUS.PARTIALLY_RETURNED]: "Partially Returned",
  [EXTERNAL_WITHDRAWAL_STATUS.FULLY_RETURNED]: "Fully Returned",
  [EXTERNAL_WITHDRAWAL_STATUS.CHARGED]: "Cobrado",
  [EXTERNAL_WITHDRAWAL_STATUS.LIQUIDATED]: "Liquidado",
  [EXTERNAL_WITHDRAWAL_STATUS.DELIVERED]: "Delivered",
};

export const EXTERNAL_WITHDRAWAL_TYPE_LABELS: Record<EXTERNAL_WITHDRAWAL_TYPE, string> = {
  [EXTERNAL_WITHDRAWAL_TYPE.RETURNABLE]: "Retornável",
  [EXTERNAL_WITHDRAWAL_TYPE.CHARGEABLE]: "Cobrável",
  [EXTERNAL_WITHDRAWAL_TYPE.COMPLIMENTARY]: "Cortesia",
};
...
export const PPE_DELIVERY_STATUS_LABELS: Record<PPE_DELIVERY_STATUS, string> = {
  [PPE_DELIVERY_STATUS.PENDING]: "Pending",
  [PPE_DELIVERY_STATUS.APPROVED]: "Approved",
  [PPE_DELIVERY_STATUS.DELIVERED]: "Delivered",
  [PPE_DELIVERY_STATUS.REPROVED]: "Reprovado",
  [PPE_DELIVERY_STATUS.CANCELLED]: "Cancelled",
};

export const ASSIGNMENT_TYPE_LABELS: Record<ASSIGNMENT_TYPE, string> = {
  [ASSIGNMENT_TYPE.ALL]: "All",
  [ASSIGNMENT_TYPE.ALL_EXCEPT]: "All Except",
...
export const NOTIFICATION_ACTION_TYPE_LABELS: Record<NOTIFICATION_ACTION_TYPE, string> = {
  ...
  [NOTIFICATION_ACTION_TYPE.APPROVE_REQUEST]: "Approve Request",
  [NOTIFICATION_ACTION_TYPE.REJECT_REQUEST]: "Reject Request",
...
export const BATCH_OPERATION_STATUS_LABELS: Record<BATCH_OPERATION_STATUS, string> = {
  ...
  [BATCH_OPERATION_STATUS.COMPLETED]: "Completed",
...
export const ACTIVITY_OPERATION_LABELS: Record<ACTIVITY_OPERATION, string> = {
  [ACTIVITY_OPERATION.INBOUND]: "Inbound",
  [ACTIVITY_OPERATION.OUTBOUND]: "Outbound",
};
...
export const ENTITY_TYPE_LABELS: Record<ENTITY_TYPE, string> = {
  ...
  [ENTITY_TYPE.CUT_PLAN]: "Cut Plan",
  [ENTITY_TYPE.CUT_REQUEST]: "Cut Request",
  ...
  [ENTITY_TYPE.PPE_REQUEST]: "PPE Request",
  [ENTITY_TYPE.PPE_DELIVERY_SCHEDULE]: "Agendamento de EPI",
  [ENTITY_TYPE.PPE_SIZE]: "Tamanho de EPI",
  [ENTITY_TYPE.EXTERNAL_WITHDRAWAL]: "External Withdrawal",
  [ENTITY_TYPE.EXTERNAL_WITHDRAWAL_ITEM]: "External Withdrawal Item",
...
export const FILE_ENTITY_TYPE_LABELS: Record<FILE_ENTITY_TYPE, string> = {
  ...
  [FILE_ENTITY_TYPE.EXTERNAL_WITHDRAWAL_BUDGET]: "External Withdrawal Budget",
  [FILE_ENTITY_TYPE.EXTERNAL_WITHDRAWAL_NFE]: "External Withdrawal NFe",
  [FILE_ENTITY_TYPE.EXTERNAL_WITHDRAWAL_RECEIPT]: "External Withdrawal Receipt",
...
export const ACTIVITY_REASON_LABELS: Record<ACTIVITY_REASON, string> = {
  [ACTIVITY_REASON.ORDER_RECEIVED]: "Order Received",
  ...
  [ACTIVITY_REASON.EXTERNAL_WITHDRAWAL]: "External Withdrawal",
  ...
  [ACTIVITY_REASON.EXTERNAL_WITHDRAWAL_RETURN]: "External Withdrawal Return",
...
export const WORKLOAD_LEVEL_LABELS: Record<WORKLOAD_LEVEL, string> = {
  ...
  [WORKLOAD_LEVEL.CRITICAL]: "Critical",
};
...
export const ACTIVITY_LEVEL_LABELS: Record<ACTIVITY_LEVEL, string> = {
  ...
  [ACTIVITY_LEVEL.ACTIVE]: "Active",
  [ACTIVITY_LEVEL.OCCASIONAL]: "Ocasional",
  [ACTIVITY_LEVEL.DORMANT]: "Inactive",
...
export const CHANGE_ACTION_LABELS: Record<CHANGE_ACTION, string> = {
  ...
  [CHANGE_ACTION.APPROVE]: "Approved",
  [CHANGE_ACTION.REJECT]: "Rejected",
  [CHANGE_ACTION.CANCEL]: "Cancelled",
  [CHANGE_ACTION.COMPLETE]: "Completed",
...
export const CHANGE_TRIGGERED_BY_LABELS: Record<CHANGE_TRIGGERED_BY, string> = {
  ...
  [CHANGE_TRIGGERED_BY.EXTERNAL_WITHDRAWAL]: "External Withdrawal",
  [CHANGE_TRIGGERED_BY.EXTERNAL_WITHDRAWAL_DELETE]: "External Withdrawal Delete",
  [CHANGE_TRIGGERED_BY.EXTERNAL_WITHDRAWAL_RETURN]: "External Withdrawal Return",
  [CHANGE_TRIGGERED_BY.EXTERNAL_WITHDRAWAL_SYNC]: "External Withdrawal Sync",
  [CHANGE_TRIGGERED_BY.EXTERNAL_WITHDRAWAL_ITEM]: "External Withdrawal Item",
  [CHANGE_TRIGGERED_BY.EXTERNAL_WITHDRAWAL_ITEM_UPDATE]: "External Withdrawal Item Update",
  [CHANGE_TRIGGERED_BY.EXTERNAL_WITHDRAWAL_ITEM_DELETE]: "External Withdrawal Item Delete",
...
export const TIMELINE_EVENT_TYPE_LABELS: Record<TIMELINE_EVENT_TYPE, string> = {
  ...
  [TIMELINE_EVENT_TYPE.COMPLETED]: "Completed",
};
...
export const ALERT_TYPE_LABELS: Record<ALERT_TYPE, string> = {
  ...
  [ALERT_TYPE.SLOW_MOVING]: "Slow Moving",
  [ALERT_TYPE.REORDER_NEEDED]: "Reposição Necessária",

  // User Alerts
  [ALERT_TYPE.HIGH_TURNOVER]: "High Turnover",
  ...
  // Borrow Alerts
  [ALERT_TYPE.HIGH_DEMAND]: "High Demand",
...
export const CHANGE_LOG_ENTITY_TYPE_LABELS: Record<CHANGE_LOG_ENTITY_TYPE, string> = {
  ...
  [CHANGE_LOG_ENTITY_TYPE.CUT_PLAN]: "Cut Plan",
  [CHANGE_LOG_ENTITY_TYPE.CUT_REQUEST]: "Cut Request",
  ...
  [CHANGE_LOG_ENTITY_TYPE.PPE_REQUEST]: "PPE Request",
  [CHANGE_LOG_ENTITY_TYPE.PPE_DELIVERY_SCHEDULE]: "Agendamento EPI",
  [CHANGE_LOG_ENTITY_TYPE.PPE_SIZE]: "Tamanho EPI",
  [CHANGE_LOG_ENTITY_TYPE.EXTERNAL_WITHDRAWAL]: "External Withdrawal",
  [CHANGE_LOG_ENTITY_TYPE.EXTERNAL_WITHDRAWAL_ITEM]: "External Withdrawal Item",
...
export const SMS_VERIFICATION_STATUS_LABELS: Record<SMS_VERIFICATION_STATUS, string> = {
  ...
  [SMS_VERIFICATION_STATUS.CANCELLED]: "Cancelled",
...
export const CAPTCHA_REQUIREMENT_LEVEL_LABELS: Record<CAPTCHA_REQUIREMENT_LEVEL, string> = {
  [CAPTCHA_REQUIREMENT_LEVEL.NONE]: "None",
...
export const VERIFICATION_ABUSE_LEVEL_LABELS: Record<VERIFICATION_ABUSE_LEVEL, string> = {
  ...
  [VERIFICATION_ABUSE_LEVEL.CRITICAL]: "Critical",
...
export const EMAIL_STATUS_LABELS: Record<EMAIL_STATUS, string> = {
  ...
  [EMAIL_STATUS.BOUNCED]: "Rejected",
  [EMAIL_STATUS.CANCELLED]: "Cancelled",
};
...
export const VERIFICATION_STATUS_LABELS: Record<VERIFICATION_STATUS, string> = {
  ...
  [VERIFICATION_STATUS.CANCELLED]: "Cancelled",
};
...
export const FAVORITE_PAGES_LABELS: Record<FAVORITE_PAGES, string> = {
  ...
  [FAVORITE_PAGES.ESTOQUE_RETIRADAS_EXTERNAS_LISTAR]: "External Withdrawals List",
  ...
  [FAVORITE_PAGES.ESTATISTICAS_RECURSOS_HUMANOS]: "Estatísticas de RH",
  ...
  [FAVORITE_PAGES.ESTOQUE_RETIRADAS_EXTERNAS_CADASTRAR]: "Register External Withdrawal",
  ...
  [FAVORITE_PAGES.RECURSOS_HUMANOS_AVISOS_LISTAR]: "Warnings List",
  ...
  [FAVORITE_PAGES.RECURSOS_HUMANOS_AVISOS_CADASTRAR]: "Register Warning",
  ...
  [FAVORITE_PAGES.PESSOAL_MEUS_AVISOS_LISTAR]: "My Warnings",
  ...
  [FAVORITE_PAGES.RECURSOS_HUMANOS_AVISOS_EDITAR]: "Edit Warning",
  ...
  [FAVORITE_PAGES.RECURSOS_HUMANOS_AVISOS_DETALHES]: "Warning Details",
  ...
  [FAVORITE_PAGES.RECURSOS_HUMANOS_AVISOS_EDITAR_LOTE]: "Batch Edit Warnings",
