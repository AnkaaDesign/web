...
export const TRUCK_CATEGORY_LABELS: Record<TRUCK_CATEGORY, string> = {
  ...
  [TRUCK_CATEGORY.SEMI_TRAILER]: 'Carreta',
...
export const CHANGE_LOG_ENTITY_TYPE_LABELS: Record<CHANGE_LOG_ENTITY_TYPE, string> = {
  ...
  [CHANGE_LOG_ENTITY_TYPE.TASK_PRICING]: "Preço da Tarefa",
...
export const FAVORITE_PAGES_LABELS: Record<FAVORITE_PAGES, string> = {
  ...
  [FAVORITE_PAGES.ADMINISTRACAO_REPRESENTANTES_LISTAR]: "Lista de Representantes",
  ...
  [FAVORITE_PAGES.PESSOAL_FERIAS_LISTAR]: "Férias",
...
export const REPRESENTATIVE_ROLE_LABELS: Record<REPRESENTATIVE_ROLE, string> = {
  [REPRESENTATIVE_ROLE.COMMERCIAL]: "Comercial",
  [REPRESENTATIVE_ROLE.MARKETING]: "Marketing",
  [REPRESENTATIVE_ROLE.COORDINATOR]: "Coordenador",
  [REPRESENTATIVE_ROLE.FINANCIAL]: "Financeiro",
  [REPRESENTATIVE_ROLE.FLEET_MANAGER]: "Gestor de Frota",
};

export const PAYMENT_CONDITION_LABELS: Record<PAYMENT_CONDITION, string> = {
  [PAYMENT_CONDITION.CASH]: "À vista",
