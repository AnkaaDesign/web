...
import { routes, CONTRACT_TYPE_LABELS, CONTRACT_STATUS } from "../../../../constants";
            ...
            {sector.users.map((user) => (
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    <Badge variant={user.currentContractStatus === CONTRACT_STATUS.ACTIVE ? "success" : "secondary"} className="text-xs">
                      {user.currentContractType ? CONTRACT_TYPE_LABELS[user.currentContractType] : "-"}
                    </Badge>
