...
export const FAVORITE_PAGES_LABELS: Record<FAVORITE_PAGES, string> = {
  ...
  [FAVORITE_PAGES.RECURSOS_HUMANOS_EPI_ENTREGAS_LISTAR]: "Entregas de EPIs (Medicina do Trabalho)",
  [FAVORITE_PAGES.RECURSOS_HUMANOS_EPI_AGENDAMENTOS_LISTAR]: "Agendamentos de EPIs (Medicina do Trabalho)",
  ...
  [FAVORITE_PAGES.RECURSOS_HUMANOS_EPI_ENTREGAS_CADASTRAR]: "Cadastrar Entrega de EPI (Medicina do Trabalho)",
  [FAVORITE_PAGES.RECURSOS_HUMANOS_EPI_AGENDAMENTOS_CADASTRAR]: "Cadastrar Agendamento de EPI (Medicina do Trabalho)",
