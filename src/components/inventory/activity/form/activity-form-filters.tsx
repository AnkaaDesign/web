...
export function ActivityFormFilters({ open, onOpenChange, filters, onFilterChange }: ActivityFormFiltersProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] h-[70vh] max-h-[700px] flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>Configure filtros para refinar a seleção de itens disponíveis</DialogDescription>
        </DialogHeader>
