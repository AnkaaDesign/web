...
import { useBatchUpdateCustomers, useBatchDeleteCustomers } from "../../../../hooks";
...
interface CustomerBatchEditDialogProps {
  isOpen: boolean;
  onClose: () => void;
...
export function CustomerBatchEditDialog({ isOpen, onClose, selectedCustomers, onSuccess }: CustomerBatchEditDialogProps) {
  ...
  const { mutateAsync: batchDeleteAsync } = useBatchDeleteCustomers();
          ...
          {isProcessing && (
            <div className="space-y-4">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                {currentOperation === "update" && "Atualizando clientes..."}
                {currentOperation === "delete" && "Excluindo clientes..."}
              </div>
          ...
          {!isProcessing && (
            <div className="space-y-6">
              ...
              <div className="max-h-32 overflow-y-auto space-y-1">
                ...
                {selectedCustomers.length > 5 && <div className="text-xs text-muted-foreground">E mais {selectedCustomers.length - 5} clientes...</div>}
              </div>
              ...
              <div className="space-y-3 p-3 border border-red-200 dark:border-red-800 rounded-lg bg-red-50/50 dark:bg-red-950/20">
                ...
                <p className="text-xs text-red-700 dark:text-red-300">Esta ação não pode ser desfeita. Todos os clientes selecionados serão excluídos permanentemente.</p>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <br />
              <br />
              Esta ação não pode ser desfeita. Todos os dados relacionados aos clientes também serão afetados.
              <br />
              <br />
              Clientes que serão excluídos:
