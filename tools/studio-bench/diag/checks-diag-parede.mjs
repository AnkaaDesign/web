/* AS DUAS PERGUNTAS QUE SOBRARAM DEPOIS DA CORRIDA DE ACEITAÇÃO.
   ===========================================================================
       node tools/studio-bench/bench.mjs --gpu --geometry --checks diag/checks-diag-parede.mjs

   ┌─ 1. QUEM É `FUSAO__borracha-preta__b0` ──────────────────────────────────┐
   │ `diag/checks-diag-niveis.mjs` nomeou a malha que existe no Médio e no Baixo e │
