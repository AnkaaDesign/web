...
import { IconFilter, IconMapPin, IconCalendarPlus, IconPackages } from "@tabler/icons-react";
...
export function SupplierFilters({ open, onOpenChange, filters, onFilterChange }: SupplierFiltersProps) {
  ...
  return (
    <FilterDrawer
      ...
      description="Configure filtros para refinar a pesquisa de fornecedores"
