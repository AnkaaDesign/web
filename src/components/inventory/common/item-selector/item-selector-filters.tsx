...
import { IconFilter, IconTriangleInverted, IconUser, IconPackages, IconCategory, IconBrandAsana, IconTruck, IconNumber, IconCurrencyDollar, IconAlertTriangleFilled } from "@tabler/icons-react";
...
/**
 * Shared item selector filters component
 * Used across multiple forms (activity, borrow, external withdrawal, order)
 * Provides full filter capabilities matching the main item list
 */

interface ItemSelectorFiltersProps {
  open: boolean;
...
export function ItemSelectorFilters({ open, onOpenChange, filters, onFilterChange }: ItemSelectorFiltersProps) {
  ...
  return (
    <FilterDrawer
      ...
      description="Configure filtros para refinar a pesquisa de itens"
