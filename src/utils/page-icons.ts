...
const PATH_PREFIX_ICON_MAP: Array<{ prefix: string; icon: Icon; color: string }> = [
  ...
  { prefix: "/departamento-pessoal/epi/entregas", icon: IconShield, color: "bg-yellow-400" },
  { prefix: "/departamento-pessoal/epi/agendamentos", icon: IconCalendar, color: "bg-yellow-400" },
  { prefix: "/departamento-pessoal/epi", icon: IconShield, color: "bg-yellow-500" },
...
export function getPageIconName(path: string): string {
  ...
  const pathIconMap: Record<string, string> = {
    ...
    "/departamento-pessoal/epi": "helmet",
    "/departamento-pessoal/epi/cadastrar": "helmet",
    "/departamento-pessoal/epi/entregas": "truck",
    "/departamento-pessoal/epi/entregas/cadastrar": "truck",
    "/departamento-pessoal/epi/agendamentos": "schedule",
    "/departamento-pessoal/epi/agendamentos/cadastrar": "schedule",
