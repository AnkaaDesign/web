...
const VALID_ROUTES = [
  ...
  routes.personnelDepartment.ppe.root,
  routes.personnelDepartment.ppe.create,
  routes.personnelDepartment.ppe.edit(":id"),
  routes.personnelDepartment.ppe.details(":id"),
  routes.personnelDepartment.ppe.deliveries.root,
  routes.personnelDepartment.ppe.deliveries.create,
  routes.personnelDepartment.ppe.deliveries.edit(":id"),
  routes.personnelDepartment.ppe.deliveries.details(":id"),
  routes.personnelDepartment.ppe.schedules.root,
  routes.personnelDepartment.ppe.schedules.create,
  routes.personnelDepartment.ppe.schedules.edit(":id"),
  routes.personnelDepartment.ppe.schedules.details(":id"),
