...
interface ExternalOperationFormFiltersProps {
  open: boolean;
...
export function ExternalOperationFormFilters({ open, onOpenChange, filters, onFilterChange }: ExternalOperationFormFiltersProps) {
      ...
      <DialogContent className="sm:max-w-[600px] h-[70vh] max-h-[700px] flex flex-col">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Filtros de Seleção de Itens - Operação Externa
            {activeFilterCount > 0 && (
          ...
          <DialogDescription>Configure filtros para refinar a seleção de itens para operação externa</DialogDescription>
        </DialogHeader>
