...
/**
 * ImplementMeasureSelector - A comprehensive component for selecting truck layouts
 *
 * Features:
...
export function ImplementMeasureSelector({
  ...
  const { data: layoutsResponse, isLoading } = useQuery({
    queryKey: ["implementMeasures", { includeUsage: true }],
    queryFn: () => implementMeasureService.listImplementMeasures({ includeUsage: true, includeSections: true }),
  ...
  const formatLayoutDisplay = (layout: ImplementMeasure) => {
    ...
    <div className={cn("w-full", className)}>
          ...
          >
            <div className="flex items-center gap-2 flex-1 truncate">
              ...
              {selectedLayout ? (
                ...
                <span className="truncate">Selecione a medida {sideLabel}</span>
              )}
            </div>
        ...
        >
          <Command>
            ...
            <CommandList>
              ...
              {layouts.length > 0 && (
                <CommandGroup heading="Medidas disponíveis">
                  {/* Clear selection option */}
                  {value && (
                    <>
                      <CommandItem
                ...
                <>
                  ...
                  <CommandGroup>
                    ...
                    >
                      ...
                      <span>Criar nova medida {sideLabel}</span>
                    </CommandItem>
                  </CommandGroup>
                </>
              )}
      ...
      {selectedLayout && (selectedLayout.usageCount || 0) > 1 && (
        <Alert variant="warning" className="mt-2">
          ...
          <AlertDescription>
            Esta medida é usada por {selectedLayout.usageCount} caminhão
