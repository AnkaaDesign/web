...
export type PayrollDiscountType =
  | 'INSS'
  | 'IRRF'
  | 'FGTS'
  | 'ABSENCE'
...
export interface Discount extends BaseEntity {
  ...
  // Employee-anchored persistent discounts (loans/advances) carry a userId and
  // a startCompetence ("YYYY-MM") instead of a single payrollId.
  userId?: string | null;
  ...
  baseValue?: DecimalValue | number | string | null;
  expirationDate?: Date | string | null;
  // Loan/installment tracking (parcelamento)
  totalInstallments?: number | null;
  currentInstallment?: number | null;
  // Master-loan classification: company loan vs CLT consignado-em-folha.
  loanKind?: 'COMPANY' | 'PAYROLL_CONSIGNED' | null;
...
export interface DiscountCreateFormData {
  ...
  value?: number | null;
  reference: string;
  discountType?: PayrollDiscountType | string;
  isPersistent?: boolean;
  expirationDate?: Date | string | null;
  totalInstallments?: number | null;
  currentInstallment?: number | null;
