...
const skeletonColumns = [
  { key: "code", width: "150px" },
  { key: "supplier.fantasyName", width: "200px" },
  { key: "status", width: "120px" },
  { key: "itemCount", width: "100px" },
  { key: "total", width: "120px" },
  { key: "forecast", width: "100px" },
  { key: "createdAt", width: "100px" },
];

export function OrderTableSkeleton({ visibleColumns, className }: OrderTableSkeletonProps) {
                ...
                {filteredColumns.map((column) => (
                  <TableCell key={column.key} className="p-0 !border-r-0" style={{ minWidth: column.width }}>
                    <div className="px-4 py-2">
                      ...
                      ) : column.key === "status" || column.key === "itemCount" ? (
