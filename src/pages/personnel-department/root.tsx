...
export const PersonnelDepartmentRootPage = () => {
  const navigate = useNavigate();
  const [timePeriod, setTimePeriod] = useState(DASHBOARD_TIME_PERIOD.THIS_MONTH);

  // Track page access
  usePageTracker({
    title: "Dashboard de Departamento Pessoal",
    icon: "users",
  });
      ...
      <div className="h-full flex flex-col bg-background">
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-6">
          <Card>
            ...
            {/* Metrics */}
            <div>
              <h3 className="text-lg font-semibold text-foreground mb-4">Métricas de Departamento Pessoal</h3>
