...
import { PositionList } from "@/components/personnel-department/position/list";
    ...
    <PrivilegeRoute requiredPrivilege={[SECTOR_PRIVILEGES.HUMAN_RESOURCES, SECTOR_PRIVILEGES.ACCOUNTING]}>
      <div className="h-full flex flex-col gap-4 bg-background px-4 pt-4">
        <PageHeader
          ...
          breadcrumbs={[{ label: "Início", href: routes.home }, { label: "Departamento Pessoal", href: routes.personnelDepartment.root }, { label: "Cargos" }]}
          actions={[
            {
              key: "adjustments",
              label: "Reajustes",
