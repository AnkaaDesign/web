...
import { BonusSummary } from "@/components/personnel-department/bonus/list/bonus-summary";
import { BonusExport } from "@/components/personnel-department/bonus/export/bonus-export";
import { BonusColumnVisibilityManager } from "@/components/personnel-department/bonus/list/bonus-column-visibility-manager";
import { FilterIndicators } from "@/components/personnel-department/bonus/list/filter-indicator";
    ...
    <PrivilegeRoute requiredPrivilege={[SECTOR_PRIVILEGES.HUMAN_RESOURCES, SECTOR_PRIVILEGES.ADMIN, SECTOR_PRIVILEGES.ACCOUNTING]}>
      <div className="h-full flex flex-col gap-4 bg-background px-4 pt-4 pb-4">
        <PageHeader
          ...
          favoritePage={FAVORITE_PAGES.DEPARTAMENTO_PESSOAL_BONUS_LISTAR}
