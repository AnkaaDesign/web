...
export function RelatedItemsCard({ items, brandId, className }: RelatedItemsCardProps) {
  ...
  const { visibleColumns, setVisibleColumns } = useColumnVisibility(
    "brand-items-visible-columns",
    new Set(["uniCode", "name", "category.name", "quantity", "price"])
  );
