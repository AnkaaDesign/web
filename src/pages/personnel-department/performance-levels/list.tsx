...
import { PerformanceLevelList } from "@/components/personnel-department/performance-levels/performance-level-list";
import { IconTrendingUp, IconDeviceFloppy, IconRestore } from "@tabler/icons-react";
import type { PerformanceLevelListRef } from "@/components/personnel-department/performance-levels/performance-level-list";
    ...
    >
      <div className="h-full flex flex-col gap-4 bg-background px-4 pt-4 pb-4">
        <PageHeader
          ...
          icon={IconTrendingUp}
          favoritePage={FAVORITE_PAGES.DEPARTAMENTO_PESSOAL_NIVEIS_DESEMPENHO_LISTAR}
