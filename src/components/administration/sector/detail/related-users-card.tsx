...
import { routes, CONTRACT_TYPE_LABELS, CONTRACT_TYPE } from "../../../../constants";
            ...
            {sector.users.map((user) => (
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  ...
                  <div className="flex items-center gap-2">
                    <Badge variant={user.currentContractType === CONTRACT_TYPE.EFFECTED ? "success" : "secondary"} className="text-xs">
