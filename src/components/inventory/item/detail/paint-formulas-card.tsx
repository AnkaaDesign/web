          ...
          <>
            {formulas.map((formula, index) => {
              ...
              return (
                <div key={formula.id}>
                  <div
                    className="bg-muted/50 rounded-lg p-4 hover:bg-muted/70 transition-all duration-200 cursor-pointer transform hover:scale-[1.02] border-2 border-transparent hover:border-red-500"
