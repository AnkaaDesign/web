...
// (purple → red → orange → yellow → lime → green) so the level chooser,
...
const COLOR_BASE: Record<number, string> = {
  0: "border-purple-200 hover:border-purple-400 hover:bg-purple-50 dark:border-purple-900/40 dark:hover:bg-purple-950/30",
...
const COLOR_SELECTED: Record<number, string> = {
  0: "border-purple-500 bg-purple-50 ring-2 ring-purple-400/60 dark:bg-purple-950/40",
