...
const EPIDeliveryDetails = () => {
  ...
  const handleEdit = () => {
    if (ppeDelivery && canManageWarehouse) {
      navigate(routes.occupationalHealth.ppe.deliveries.edit(ppeDelivery.id));
    }
  };
              ...
              <div className="text-center px-4 max-w-md mx-auto">
                <div className="animate-in fade-in-50 duration-500">
                  ...
                  <div className="space-y-3">
                    <Button onClick={() => navigate(routes.occupationalHealth.ppe.deliveries.root)} className="w-full sm:w-auto">
    ...
    <PrivilegeRoute requiredPrivilege={[SECTOR_PRIVILEGES.HUMAN_RESOURCES, SECTOR_PRIVILEGES.WAREHOUSE, SECTOR_PRIVILEGES.ACCOUNTING]}>
      <div className="h-full flex flex-col px-4 pt-4">
        ...
        <div className="flex-1 overflow-y-auto pb-6">
          {/* Content Grid */}
          <div className="mt-4 animate-in fade-in-50 duration-700 space-y-4">
