...
export interface CalendarProps extends Omit<DayPickerProps, "components" | "classNames" | "className"> {
  /**
  ...
  className?: string;
  /** Custom class names for styling internal components */
  classNames?: Partial<DayPickerProps["classNames"]>;
  /** Custom components to replace default ones */
  components?: Partial<DayPickerProps["components"]>;
}

/**
 * Calendar component that wraps react-day-picker with custom styling.
 * Supports all DayPicker props including:
 * - `mode`: "single" | "multiple" | "range"
 * - `selected`: Date | Date[] | DateRange depending on mode
 * - `onSelect`: Callback for date selection
 * - `disabled`: Date matcher for disabled dates
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        today: cn("bg-accent text-white rounded-md data-[selected=true]:rounded-none", defaultClassNames.today),
