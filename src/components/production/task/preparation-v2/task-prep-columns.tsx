...
const ALL_TASK_PREP_COLUMN_IDS = [
  ...
  "forecastDate", "term", "total", "paymentStatus", "bonification",
...
export const TASK_PREP_SECTOR_DEFAULTS: Partial<Record<SECTOR_PRIVILEGES, Partial<PersistedTableConfig>>> = {
  ...
  [SECTOR_PRIVILEGES.FINANCIAL]: sectorConfig(["customer", "total", "paymentStatus", "name", "identificador", "forecastDate", "term", "soCommercial", "soLogistic", "bonification"]),
