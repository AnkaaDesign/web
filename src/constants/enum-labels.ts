...
export const INSTALLMENT_PAYMENT_METHOD_LABELS: Record<INSTALLMENT_PAYMENT_METHOD, string> = {
  [INSTALLMENT_PAYMENT_METHOD.PIX]: "Pix",
  [INSTALLMENT_PAYMENT_METHOD.BANK_SLIP]: "Boleto",
  [INSTALLMENT_PAYMENT_METHOD.CASH]: "Dinheiro",
  [INSTALLMENT_PAYMENT_METHOD.TRANSFER]: "Transferência",
  [INSTALLMENT_PAYMENT_METHOD.ACCOUNT_GENIVALDO]: "Conta Genivaldo",
  [INSTALLMENT_PAYMENT_METHOD.ACCOUNT_SERGIO]: "Conta Sérgio",
  [INSTALLMENT_PAYMENT_METHOD.MANUAL]: "Manual",
  [INSTALLMENT_PAYMENT_METHOD.OTHER]: "Outro",
};
...
export const AIRBRUSHING_STATUS_LABELS: Record<AIRBRUSHING_STATUS, string> = {
  [AIRBRUSHING_STATUS.QUOTING]: "Em Cotação",
  [AIRBRUSHING_STATUS.PREPARATION]: "Em Preparação",
  [AIRBRUSHING_STATUS.WAITING_PRODUCTION]: "Aguardando Produção",
...
export const AIRBRUSHING_QUOTE_STATUS_LABELS: Record<AIRBRUSHING_QUOTE_STATUS, string> = {
  [AIRBRUSHING_QUOTE_STATUS.PROPOSED]: "Proposta Recebida",
  [AIRBRUSHING_QUOTE_STATUS.COUNTERED]: "Contraproposta Enviada",
  [AIRBRUSHING_QUOTE_STATUS.ACCEPTED]: "Aceitou a Contraproposta",
  [AIRBRUSHING_QUOTE_STATUS.DECLINED]: "Recusou",
  [AIRBRUSHING_QUOTE_STATUS.SELECTED]: "Selecionado",
  [AIRBRUSHING_QUOTE_STATUS.NOT_SELECTED]: "Não Selecionado",
};

export const AIRBRUSHING_QUOTE_ACTION_LABELS: Record<AIRBRUSHING_QUOTE_ACTION, string> = {
  [AIRBRUSHING_QUOTE_ACTION.PROPOSAL]: "Proposta",
  [AIRBRUSHING_QUOTE_ACTION.COUNTER]: "Contraproposta",
  [AIRBRUSHING_QUOTE_ACTION.ACCEPT]: "Aceite",
  [AIRBRUSHING_QUOTE_ACTION.DECLINE]: "Recusa",
  [AIRBRUSHING_QUOTE_ACTION.SELECT]: "Seleção",
  [AIRBRUSHING_QUOTE_ACTION.CLOSE]: "Encerramento",
};

export const EXECUTION_TIME_UNIT_LABELS: Record<EXECUTION_TIME_UNIT, string> = {
  [EXECUTION_TIME_UNIT.HOURS]: "Horas",
  [EXECUTION_TIME_UNIT.DAYS]: "Dias",
};
...
export const VERIFICATION_TYPE_LABELS: Record<VERIFICATION_TYPE, string> = {
  ...
  [VERIFICATION_TYPE.FIRST_ACCESS]: "Primeiro Acesso",
};
...
export const ENTITY_TYPE_LABELS: Record<ENTITY_TYPE, string> = {
  ...
  [ENTITY_TYPE.IMPLEMENT]: "Implemento",
...
export const CHANGE_LOG_ENTITY_TYPE_LABELS: Record<CHANGE_LOG_ENTITY_TYPE, string> = {
  ...
  [CHANGE_LOG_ENTITY_TYPE.IMPLEMENT]: "Implemento",
...
export const FAVORITE_PAGES_LABELS: Record<FAVORITE_PAGES, string> = {
  ...
  [FAVORITE_PAGES.ADMINISTRACAO_ORCAMENTO_PINTURA_LISTAR]: "Orçamentos de Pintura",
  [FAVORITE_PAGES.ADMINISTRACAO_ORCAMENTO_PINTURA_CADASTRAR]: "Novo Orçamento de Pintura",
  ...
  [FAVORITE_PAGES.FERRAMENTAS_ESTUDIO_3D]: "Estúdio 3D",
  // Servidor
