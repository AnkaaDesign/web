...
export const CHANGE_TRIGGERED_BY_LABELS: Record<CHANGE_TRIGGERED_BY, string> = {
  ...
  [CHANGE_TRIGGERED_BY.EXTERNAL_WITHDRAWAL_RETURN]: "Retorno de Retirada Externa",
...
export const FAVORITE_PAGES_LABELS: Record<FAVORITE_PAGES, string> = {
  ...
  [FAVORITE_PAGES.ESTOQUE_ESTATISTICAS_TENDENCIAS]: "Tendências do Estoque",
  [FAVORITE_PAGES.ESTOQUE_TOP_ITENS]: "Principais Itens",
  ...
  [FAVORITE_PAGES.ESTATISTICAS_FINANCEIRO_COBRANCAS]: "Estatísticas - Cobranças",
  [FAVORITE_PAGES.ESTATISTICAS_FINANCEIRO_BOLETOS]: "Estatísticas - Boletos",
  [FAVORITE_PAGES.ESTATISTICAS_FINANCEIRO_RECEITA]: "Estatísticas - Receita & Orçamentos",
  [FAVORITE_PAGES.ESTATISTICAS_FINANCEIRO_RECEBIVEIS]: "Estatísticas - Recebíveis",
  ...
  [FAVORITE_PAGES.RECURSOS_HUMANOS_AUSENCIAS_LISTAR]: "Lista de Ausências",
  [FAVORITE_PAGES.RECURSOS_HUMANOS_FALTAS_LISTAR]: "Lista de Faltas",
  [FAVORITE_PAGES.RECURSOS_HUMANOS_CALENDARIO]: "Calendário",
  ...
  [FAVORITE_PAGES.RECURSOS_HUMANOS_CONTROLE_PONTO_LISTAR]: "Controle de Ponto",
  [FAVORITE_PAGES.RECURSOS_HUMANOS_CONTROLE_PONTO_ASSINATURA_DIGITAL_LISTAR]: "Assinatura Digital de Cartão Ponto",
  ...
  [FAVORITE_PAGES.RECURSOS_HUMANOS_EPI_TAMANHOS_LISTAR]: "Tamanhos de EPIs (RH)",
  [FAVORITE_PAGES.RECURSOS_HUMANOS_SETORES_LISTAR]: "Lista de Setores (RH)",
  [FAVORITE_PAGES.RECURSOS_HUMANOS_BONUS_LISTAR]: "Bônus",
  [FAVORITE_PAGES.RECURSOS_HUMANOS_NIVEIS_DESEMPENHO_LISTAR]: "Níveis de Desempenho",

  // Human Resources - Create Pages
  [FAVORITE_PAGES.RECURSOS_HUMANOS_CARGOS_CADASTRAR]: "Cadastrar Cargo",
  [FAVORITE_PAGES.RECURSOS_HUMANOS_AUSENCIAS_CADASTRAR]: "Cadastrar Ausência",
  [FAVORITE_PAGES.RECURSOS_HUMANOS_FALTAS_CADASTRAR]: "Cadastrar Falta",
  ...
  [FAVORITE_PAGES.RECURSOS_HUMANOS_AUSENCIAS_EDITAR]: "Editar Ausência",
  [FAVORITE_PAGES.RECURSOS_HUMANOS_FALTAS_EDITAR]: "Editar Falta",
  ...
  [FAVORITE_PAGES.RECURSOS_HUMANOS_AUSENCIAS_DETALHES]: "Detalhes da Ausência",
  [FAVORITE_PAGES.RECURSOS_HUMANOS_FALTAS_DETALHES]: "Detalhes da Falta",
