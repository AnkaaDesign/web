...
import { IconMapPin, IconHome, IconBuildingCommunity, IconMap, IconMailbox } from "@tabler/icons-react";
    ...
    <Card className={cn("shadow-sm border border-border flex flex-col", className)} level={1}>
      ...
      <CardContent className="pt-0 flex-1">
        <div className="space-y-6">
          {hasAddress ? (
            <div>
              <h3 className="text-base font-semibold mb-4 text-foreground">Localização</h3>
