/**
 * Generates an SVG string representing an implement measure with sections, doors, and dimensions.
 * Used in changelog displays to visualize implement measure changes.
 */
export const generateImplementMeasureSVG = (measure: any): string => {
  if (!measure || !measure.sections) return "";

  const height = (measure.height || 0) * 100; // Convert to cm
