...
import { scene, camera, onFrame, onRig } from './scene.js';
...
/* ---------------- shared quad ---------------- */
function instancedQuad(count, extraAttrs) {
...
export function initWeather() {
  rainMesh = makeRain();
  rippleMesh = makeRipples();
  scene.add(rainMesh, rippleMesh);
