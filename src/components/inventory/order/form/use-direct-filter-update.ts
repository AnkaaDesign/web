...
/**
 * Direct URL filter update hook that bypasses the complex useUrlFilters chain
 * This provides immediate, atomic updates like the item list page uses
 */
  ...
  const clearAllFilters = useCallback(() => {
    setSearchParams(
      (prev) => {
        ...
        // Clear all filter params but preserve others like sort
        params.delete("showInactive");
        params.delete("categoryIds");
        params.delete("brandIds");
        params.delete("supplierIds");
